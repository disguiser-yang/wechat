mui.init();
//职工风获取频道
mui.get('/puhuihua/wechat/legal/channelList', function(data){
        ...
        (function(m) {
            ...
            m.ready(function() {
                ...
                var createFragment = function(x,ul, index, count, reverse) {
                    ...
                    /*获取列表*/
                    mui.get('/puhuihua/wechat/legal/legalIssueList',{
                        pageNo:pageNo,
                        ...
                        function(data){
                            if(data.success){
                                ...
                                //懒加载图片
                                m('.mui-table-view').imageLazyload({
...
mui("body").on('tap', ".list",function() {
   ...
   window.location.href='law-publicity-detail.html?issueId='+issueId
});
//阻止线程，使tab加载完再模拟点击事件
